...
//TODO: to be removed after all functionalities ported to Layout
  ...
  return (
    <div>
      <div className="flex flex-row p-2 justify-start items-center border-b-2 border-b-gray-500">
        <div className="mr-auto text-2xl font-bold">Perma-Tweeter</div>
        <ul className="flex">
          <li className="mr-6">
            <Link href="/tweets" legacyBehavior>
              <a className="text-primary hover:text-blue-800 text-lg font-semibold">Timeline</a>
            </Link>
          </li>
          <li className="mr-6">
            <Link href="/crosspost" legacyBehavior>
              <a className="text-primary hover:text-blue-800 text-lg font-semibold">
                Cross-post tweet
              </a>
            </Link>
          </li>
